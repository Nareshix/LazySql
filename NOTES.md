...
1. chrono/time/jiff or other datetime-based library support
...
document generateed method like transaction transaction imemedite etc
e.g.
...
1. hover over funciton works great on vscode. untested in other editors
