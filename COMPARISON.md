...
|---|---|---|---|
| Compile-time checks | ✅ | ❌ | ✅ |
|Speed|Fast by default. Automatically caches all preparred statements. It also applies [optimal pragma settings](./sqlitex/Documentation.md) by default|Fast with configuration|Fast (not tested)|
