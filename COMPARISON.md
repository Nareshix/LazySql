...
| ----------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------- | ----------------- |
| Compile-time checks                       | ✅, works out of the box                                                                                                                                                                        | ❌                      | ✅, but setup is needed                |
...
| Bulk operations api                       | ✅ (`_bulk` auto-generated, although it is limited to adding a list of tuples for now)                                                                                                                                               | ❌                      | ❌                |
