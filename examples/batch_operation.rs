...
fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    // the add_user_bulk is autogenerated even tho it wasnt specified when defining them in the struct above
    // All write statement would automatically have a _bulk function which you can use for bulk operations
    // Note that it is atomic and if you want fine grain control on how much to commit, use transactions
    db.add_user_bulk(&bulk)?;
